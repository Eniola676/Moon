  ...
  return (
    <div>
        ...
        <div className='md:flex items-center md:justify-between pt-6 bg-blue'>
            <img src={europa}  alt="" className="md:w-[25%] w-[12%] md:py-0 py-4  mx-auto hover:animate-pulse"/>
            <div className='md:w-1/2'>
                ...
                <h1 className='text-white w-full font-Bellefair pb-2 text-7xl text-center md:text-left md:pt-3 '>EUROPA</h1>
